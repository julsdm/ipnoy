                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $row->merchid;?></td>
                          <td><?php echo $row->merch_username;?></td>
                          <td><?php echo $row->merch_password;?></td>
                          <td><a href="<?php echo site_url('admin/dashboard/deleteuser2');?>/<?php echo $row->merchid;?>" class="btn btn-danger">Delete</a></td>
                        </tr>
                        <?php }?>
                      </tbody>
                    </table>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="<?php echo site_url('admin/dashboard/adduser2')?>">
