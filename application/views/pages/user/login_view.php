...
body{
	...
	background-attachment: fixed;
		...
		<div class="wrap-login100">
			<form action="<?php echo site_url('user/Userlogin/validatelogin') ;?>" method="post"  class="validate-form">
				<div>
					
					<span class="login100-form-title-1">
					<h2 style="color: black";>Sign In</h2>
					</span><img src="<?php echo base_url()."assets/";?>Login_v15/images/bg-01.jpg"width="800" height="200">
				</div>
				...
				<span class="container-fluid">
					...
					<div class="wrap-input100 validate-input m-b-9" data-validate = "Username is required">
						<input class="input100" type="text" name="username" maxlength="25">
					...
					<div class="container-login100-form-btn">
						...
						<div onclick = "window.location='<?php echo site_url('merchant/dashboard/merchlog');?>'" ;>
				<button class="login100-form-btn">	Merchant
				</button> </div>
				<div onclick = "window.location='<?php echo site_url('admin/dashboard/adminlogin');?>'";> 
				<button class="login100-form-btn"> Admin	
				</button></form>
					</div>
				</div>
			</div>
