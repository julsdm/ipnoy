...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<form action="<?php echo site_url('merchant/dashboard/merchvalidate') ;?>" method="post"  class="validate-form">
				<div>

					<span class="login100-form-title-1">
					<h2 style="color: black";>	Sign In</h2>
					<img src="<?php echo base_url()."assets/";?>Login_v15/images/bg-01.jpg" width="800" height="200">
					</span>
				</div>
