...
<br>
<br>
    <form action="<?php echo site_url('merchant/addprod/addprods') ;?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="name" name="prodname" placeholder="Product Name" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" id="email" name="description"  placeholder="Product Description" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" name="category" id="message" rows="1" placeholder="Category">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" name="type" id="message" rows="1" placeholder="Type">
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" name="price" id="message" rows="1" placeholder="Price" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <input type="text" class="form-control" name="quantity" id="message" rows="1" placeholder="Quantity" required>
                                    </div>
                                    <div class="form-group col-lg-12">
                                    <h4 style="color:black";>Product Picture</h4>
                                        <input type="file" id="subject" name="prodpic" >
                                    </div>
                                    

                                    <div class="form-group col-md-12">
                                        <button type="submit" value="submit" class="btn submit_btn2 form-control">Add Product</button>
                                    </div>
                                </form>
